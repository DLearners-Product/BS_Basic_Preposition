...
public class T5DoTweenManager : MonoBehaviour
{
   public GameObject[] objects; // Array of GameObjects to activate
    ...
    public Color clickFlashColor = Color.yellow; // Color to flash on click
    public float clickEffectDuration = 0.3f; // Duration of the click effect
